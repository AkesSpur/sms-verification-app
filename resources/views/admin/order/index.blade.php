                                        ...
                                        <table class="table table-striped dataTable no-footer" id="table-2" role="grid"
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-capitalize">
                                                            @foreach ($order->orderItems as $orderItem)
                                                                @if ($orderItem->product_type == 'pdf')
                                                                    <div class="badge badge-danger mt-2">
                                                                        {{ $orderItem->product_type }}
                                                                    </div>
                                                                @break

                                                            @elseif ($orderItem->product_type == 'gift')
                                            ...
                                            <td>
                                                @if ($order->status == 'completed')
                                                    <div class="p-2 text-capitalize badge badge-success">
                                                        {{ $order->status }}
                                                    </div>
                                                ...
                                                @else
                                                <div class="p-2 text-capitalize badge badge-danger">
                                                    {{ $order->status }}
                                                </div>
                                                @endif
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="bottom-start"
                                                        ...
                                                        href="{{ route('admin.gift-info', $order->id) }}"><i class="far fa-file">
                                                        </i> View Gift Info
                                                      </a>
                                                      <a class="dropdown-item has-icon"
                                                          href="{{ route('admin.update-gift-order', $order->id) }}"><i
                                                              class="far fa-edit">
