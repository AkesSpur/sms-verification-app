...
<section class="section">
    <div class="section-header">
        <h1>Create New Social Media Product</h1>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.social-media-products.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote @error('description') is-invalid @enderror" 
                                              id="description" 
                                              name="description" 
                                              placeholder="Describe this product, its features, and delivery details...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" 
                                            ...
                                            name="status" 
                                            required>
                                        <option value="1" {{ old('status', default: 1) === 1 ? 'selected' : '' }}>Active</option>
